...
WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/FiltrarNumeroOca'), [('varNumOCA') : '2051-0169-OCA20'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/ClickNueva'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/AccederMenuNueva'), [('varOpcion') : 'Sap'], FailureHandling.STOP_ON_FAILURE)
