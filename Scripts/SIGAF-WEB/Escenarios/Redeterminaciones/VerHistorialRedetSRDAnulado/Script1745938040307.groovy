...
WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/ClickHistorico'), [:], FailureHandling.STOP_ON_FAILURE)

historico = WebUI.verifyElementPresent(findTestObject('SIGAF-WEB/Page_sigaf-redet-historico/h1_Histrico'), 2)

WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/ClickCerrarHistorico'), [:], FailureHandling.STOP_ON_FAILURE)
