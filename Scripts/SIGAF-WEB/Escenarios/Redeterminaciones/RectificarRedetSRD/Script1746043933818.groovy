...
WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/IngresarEstado'), [('varOpcion') : 'autorizado'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('SIGAF-WEB/Page_sigaf-redet-rectificar/button_Rectificar'), 2)

WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/ClickRectificar'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('SIGAF-WEB/Page_sigaf-redet-rectificar/textarea_comentarioRectificar'), 'Se rectifica la solicitud')

WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/ClickConfirmarRectificar'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/EsperarGifCarga'), [:], FailureHandling.STOP_ON_FAILURE)

rectificada = WebUI.verifyElementPresent(findTestObject('SIGAF-WEB/Page_sigaf-redet-rectificar/div_msjRectificacionExitosa'), 
    2)
