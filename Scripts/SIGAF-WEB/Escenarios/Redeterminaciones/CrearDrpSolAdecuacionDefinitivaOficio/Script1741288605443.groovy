...
WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/AccederMenuOCA'), [('varOpcion') : 'Devengado'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/ClickNuevoDRP'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF-WEB/Genericos/AccederMenuNuevoDrp'), [('varOpcion') : 'DrpSado'], FailureHandling.STOP_ON_FAILURE)
