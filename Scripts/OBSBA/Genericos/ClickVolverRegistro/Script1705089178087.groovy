...
WebUI.waitForElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_Registrar/button_RegistroVOLVERSubmit'), 2)

WebUI.click(findTestObject('ObsbaPortal/Page_ObSBA_Registrar/button_RegistroVOLVERSubmit'))
