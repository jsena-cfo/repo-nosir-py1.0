...
not_run: mensaje = WebUI.callTestCase(findTestCase('OBSBA/Genericos/SubirDocumento'), [('varTitulo') : titulo, ('varDescripcion') : descripcion
        , ('varPathFile') : pathFile, ('varUsuario') : 'Interno'], FailureHandling.STOP_ON_FAILURE)

subido = WebUI.callTestCase(findTestCase('OBSBA/Genericos/SubirDocumentoMsj'), [('varTitulo') : titulo, ('varDescripcion') : descripcion
        , ('varPathFile') : pathFile, ('varUsuario') : 'Interno', ('varMsjValidado') : 'Archivo subido correctamente'], 
    FailureHandling.STOP_ON_FAILURE)
...
System.out.println('Carpeta: ' + carpeta1.substring(5))

System.out.println('Carpeta Doc: ' + carpeta2.substring(5))

String mensajeNew = (('  ->Carpeta: ' + carpeta1.substring(5)) + ' Carpeta Doc: ') + carpeta2.substring(5)

WebUI.callTestCase(findTestCase('OBSBA/Genericos/EscribirATxt'), [('varText') : mensajeNew, ('varTextPath') : 'Txt/cuilUsed.txt'], 
    FailureHandling.STOP_ON_FAILURE)
