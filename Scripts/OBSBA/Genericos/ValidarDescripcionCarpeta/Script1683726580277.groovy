...
WebUI.sendKeys(findTestObject('ObsbaPortal/Page_ObSBA_CrearCarpeta/input_Titulo de Carpeta'), 'validar campo')

not_run: WebUI.scrollToElement(findTestObject('ObsbaPortal/Page_ObSBA_CrearCarpeta/span_Guardar'), 2)

not_run: WebUI.click(findTestObject('ObsbaPortal/Page_ObSBA_CrearCarpeta/span_Guardar'))

WebUI.callTestCase(findTestCase('OBSBA/Genericos/ClickGuardar'), [:], FailureHandling.STOP_ON_FAILURE)

presente = WebUI.verifyElementVisible(findTestObject('ObsbaPortal/Page_ObSBA_CrearCarpeta/p_Campo obligatorioDescripcion'))
