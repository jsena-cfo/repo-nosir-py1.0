...
String msjValidado= this.getBinding().getAt('varMsjValidado').toString()
...
case 'Prueba descripcion 30MB':
	...
	WebUI.waitForElementVisible(findTestObject('ObsbaPortal/Page_ObSBA_AdministrarCarpetaDocumento/span_maximoPermitido25MB'), 1)
