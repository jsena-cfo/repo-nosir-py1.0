...
String path
//path = 'C:\\Devs\\Projects\\Katalon\\NOSIR\\Xls\\obsba\\usersSigafXls\\usuariosTmpPre.xlsx'

String pathXls= WebUI.callTestCase(findTestCase('OBSBA/Genericos/ObtenerPathXlsTmpEntorno'), [('varUrl') : strUrl, ('varTipo') : 'usuarios'],
...
if (strUrl.contains('obsba-preprod.dguiaf-gcba.gov')) {
	path= dirName + '/Xls/obsba/usersSigafXls/usuariosTmpPre.xlsx'
	  ...
	  }//https://obsba-desa.dguiaf-gcba.gov.ar/
	  else { 
...
XSSFSheet sheet = workbook.getSheet(perfil)
...
cell.setCellValue(cuitSinGuionesYBlancos)
