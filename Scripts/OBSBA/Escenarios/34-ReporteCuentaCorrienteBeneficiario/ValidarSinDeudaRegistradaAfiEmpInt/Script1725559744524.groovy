...
WebUI.waitForElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_MensajeInformacion/h2_Atencin'), 2)

not_run: WebUI.waitForElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_MensajeInformacion/p_msjNoDeudaRegistrada'), 
    2)
...
**/
(mapBoolean['1']) = WebUI.callTestCase(findTestCase('OBSBA/Genericos/ValidarMensajeModalTexto'), [('varTexto') : '¡Atención!'], 
...
(mapBoolean['2']) = WebUI.callTestCase(findTestCase('OBSBA/Genericos/ValidarMensajeModalTexto'), [('varTexto') : 'No tiene deuda registrada.'], 
    FailureHandling.STOP_ON_FAILURE)
