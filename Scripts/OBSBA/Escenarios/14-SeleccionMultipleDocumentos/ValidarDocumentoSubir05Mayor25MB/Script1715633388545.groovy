...
/**Author: Jer**/
/**Se cargan varios archivos simultaneamnete (5) que sumados dan mas de 25MB
...
String archivosMultiples = '"pruebaXlsBigFile05" "pruebaXlsBigFile" "pruebaXlsBigFile02" "pruebaXlsBigFile03" "pruebaXlsBigFile04" '
...
validar = WebUI.callTestCase(findTestCase('OBSBA/Genericos/SubirDocumentoMsj'), [('varTitulo') : 'Prueba titulo pdf30mb'
        , ('varDescripcion') : 'Prueba descripcion 30MB', ('varPathFile') : pathFormateado, ('varUsuario') : 'Externo', ('varMsjValidado') : msj], 
    FailureHandling.STOP_ON_FAILURE)
