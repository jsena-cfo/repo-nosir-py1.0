 ...
 *Se aplica filtro que genera un listado para el usuario, 
...
'Filtra desde el 01/06/2023 al dia 05/07/2023'
String anio = '2023'

String fechaDesde = '01062023'

String fechaHasta = CustomKeywords.'tool.DateGenerator.today'()

not_run: WebUI.callTestCase(findTestCase('OBSBA/Genericos/ConsultarCarpeta'), [('varAnio') : anio, ('varNumeroCarpeta') : ''
        , ('varFechaDesde') : fechaDesde, ('varFechaHasta') : '05072023', ('varCuil') : ''], FailureHandling.STOP_ON_FAILURE)
