...
/**Author: Jer**/
/**El script valida que en el momento del login se cargue una contraseña valida**/
...
WebUI.setText(findTestObject('ObsbaPortal/Page_ObSBA_Login/inputContrasena'), ContrasenaError)

WebUI.waitForElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_ValidadorContrasea/p_mensajeContraseaErrorSesion'), 2)
