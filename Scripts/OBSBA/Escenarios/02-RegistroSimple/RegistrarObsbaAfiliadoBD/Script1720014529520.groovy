...
if (((mapData['1']) != null) && ((mapData['2']) != null)) {
    ...
    not_run: WebUI.callTestCase(findTestCase('OBSBA/Genericos/CompletarDatosInterno'), [('varUser') : usuario, ('varCuil') : cuit
    ...
    WebUI.callTestCase(findTestCase('OBSBA/Genericos/RellenarDatosAfiliadoPrestador'), [('varUsuario') : usuario, ('varCuil') : cuilSinGuiones
            , ('varPassword') : password, ('varDomicilio') : varDomicilio, ('varTelefono') : varTelefono, ('varEmail') : varEmail
    ...
    if (registroSatisfactorio == true) {
        //cuilSinGuiones = CustomKeywords.'adicionales.CuilRandomGenerator.quitarGuionesyBlancos'(cuit)
        ...
        WebUI.callTestCase(findTestCase('OBSBA/Genericos/EscribirALog'), [('varTexto') : '***Usuario Afiliado para varios roles Registrado: '], 
        ...
        WebUI.callTestCase(findTestCase('OBSBA/Genericos/EscribirALog'), [('varTexto') : '***Log: Cantidad Registros disponible: ' + 
