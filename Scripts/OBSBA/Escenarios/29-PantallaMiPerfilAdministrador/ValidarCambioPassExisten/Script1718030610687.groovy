...
WebUI.scrollToElement(findTestObject('ObsbaPortal/Page_ObSBA_MiPerfil/inputNuevaContrasena'), 1)

(mapBoolean['1']) = WebUI.verifyElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_MiPerfil/inputNuevaContrasena'), 1)

(mapBoolean['2']) = WebUI.verifyElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_MiPerfil/inputRepitaContrasea'), 1)
