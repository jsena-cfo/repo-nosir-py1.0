...
/**Author: Jer**/
/**Ingresa como Prestado y selecciona para cargar una carpeta con tipo Reintegro**/
/**Valida que el usr no observa los campos Importe de Carpeta, Fecha de Prestacion 
 * y CUIT del Bnef**/
...
WebUI.callTestCase(findTestCase('OBSBA/Genericos/SeleccionarTipoCarpeta'), [('varTipoCarpeta') : 'Reintegro'], FailureHandling.STOP_ON_FAILURE)
