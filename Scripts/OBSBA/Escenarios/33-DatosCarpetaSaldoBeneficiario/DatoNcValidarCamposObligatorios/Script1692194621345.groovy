...
/**Author: Jer**/
/**Ingresa comprestador y valida los mensajes de validacion de campos**/
...
//WebUI.verifyElementVisible(findTestObject('ObsbaPortal/Page_ObSBA_CrearCarpeta/p_mensajeFechaPrestacion'), FailureHandling.OPTIONAL)
//WebUI.verifyElementVisible(findTestObject('ObsbaPortal/Page_ObSBA_CrearCarpeta/p_mensajeImportePrestacion'), FailureHandling.OPTIONAL)
def mapBoolean

boolean ingreso = false

mapBoolean = [('1') : WebUI.verifyElementVisible(findTestObject('ObsbaPortal/Page_ObSBA_CrearCarpeta/p_mensajeFechaPrestacion'), 
        FailureHandling.OPTIONAL), ('2') : WebUI.verifyElementVisible(findTestObject('ObsbaPortal/Page_ObSBA_CrearCarpeta/p_mensajeImportePrestacion'), 
