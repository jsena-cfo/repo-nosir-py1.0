...
/**Author: Jer**/
/**Ingresa como Prestador y no seleccionando tipo de carpeta Reintegro**/
...
boolean bool01 = WebUI.verifyElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_CrearCarpeta/input_CUITBenefPago'), 1, 
...
//boolean bool03 = WebUI.verifyElementVisible('ObsbaPortal/Page_ObSBA_CrearCarpeta/input_ImportePrestacion', FailureHandling.OPTIONAL)
def mapBoolean
