...
not_run: WebUI.callTestCase(findTestCase('OBSBA/Genericos/EscribirALogUsuario'), [('varAfiliado') : GlobalVariable.cuitAfiliado
        , ('varPrestador') : GlobalVariable.cuitPrestador, ('varInterno') : GlobalVariable.cuitInterno, ('varEmpleado') : GlobalVariable.cuitEmpleado
        , ('varAdministrador') : GlobalVariable.cuitAdministrador], FailureHandling.STOP_ON_FAILURE)
