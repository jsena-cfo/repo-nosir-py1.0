...
//String sql3 = CustomKeywords.'tool.SqlQueriesObsba.queryObtenerUsuarioSiguienteInsertado'(nombreCuitMin, nombreCuitMax)

String sql = CustomKeywords.'tool.SqlQueriesObsba.queryObtenerUsuarioSiguienteInsertadoEmpleado'(nombreCuitMin, nombreCuitMax)
...
if (estaVacio== false) {
	...
	String usuario= CustomKeywords.'com.katalon.plugin.keyword.connection.ResultSetKeywords.getListCellValue'(actorData, 'XC_USER')
