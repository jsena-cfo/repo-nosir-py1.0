...
/**Author: Jer**/
/**Se loguea como Interno, valida que se haya logueado**/
...
(mapBoolean['2']) = WebUI.verifyElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_Login/inputCUIL'), 2, FailureHandling.STOP_ON_FAILURE)
