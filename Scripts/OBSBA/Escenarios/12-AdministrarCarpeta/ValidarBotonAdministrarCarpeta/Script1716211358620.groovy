...
/**Author: Jer**/
/**Valida que existe y funciona correctamente el botón**/
...
(mapBoolean['1']) = WebUI.verifyElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_AdministrarCarpetaDocumento/a_buttonAdmnistrarCarpeta'), 
    2)
...
(mapBoolean['2']) = WebUI.verifyElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_AdministrarCarpeta/label_Administrar Carpeta'), 
    1)
