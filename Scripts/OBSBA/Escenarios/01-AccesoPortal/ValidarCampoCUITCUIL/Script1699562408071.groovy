...
/**Script valida que existe el campo CUIL**/
WebUI.callTestCase(findTestCase('OBSBA/Genericos/AbrirURL'), [('varUrl') : Url], FailureHandling.STOP_ON_FAILURE)

def existeCUILCUIT = WebUI.verifyElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_Login/inputCUIL'), 1)

assert existeCUILCUIT == true
