...
/**Author: JER**/
/**Script carga un prestador y luego intenta registrarlo como afiliado**/
...
WebUI.callTestCase(findTestCase('OBSBA/Genericos/AbrirURL'), [('varUrl') : varUrl], FailureHandling.STOP_ON_FAILURE)
...
'Intentar registrarlo como afiliado'
WebUI.callTestCase(findTestCase('OBSBA/Genericos/RellenarDatosAfiliadoPrestador'), [('varUsuario') : userPrestador, ('varCuil') : cuilSinGuiones
        , ('varPassword') : varPassword, ('varDomicilio') : varDomicilio, ('varTelefono') : varTelefono, ('varEmail') : emailMayus
