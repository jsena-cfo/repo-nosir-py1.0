...
'Registrar empleado'
String cuil = WebUI.callTestCase(findTestCase('OBSBA/Escenarios/02-RegistroSimple/RegistrarEmpleadoAlt'), [('password') : varPassword
        , ('telefono') : varTelefono, ('direccion') : varDomicilio, ('email') : varEmail, ('url') : varUrl], FailureHandling.STOP_ON_FAILURE)
...
String valorTexto = '\n' + '***Log: Valida mensaje error: Registra un empleado y luego intenta registrarlo con los mismos datos como prestador: ' + cuil.toString() + '\n'
