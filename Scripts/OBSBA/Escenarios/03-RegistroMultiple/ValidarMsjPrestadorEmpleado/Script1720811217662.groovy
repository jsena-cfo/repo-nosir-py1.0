...
'Lo intenta registrar como empleado'
WebUI.callTestCase(findTestCase('OBSBA/Genericos/CompletarDatosEmpleadoAlt'), [('varEmail') : emailMayus, ('varPassword') : varPassword
        , ('varCuit') : cuilSinGuiones, ('varUser') : userPrestador, ('varTelefono') : varTelefono, ('varDireccion') : varDomicilio
