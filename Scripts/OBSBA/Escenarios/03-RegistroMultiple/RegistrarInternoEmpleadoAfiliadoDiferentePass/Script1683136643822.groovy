...
/**Script registra como interno, empleado y trata registrarlo con afiliado con otro password**/
...
WebUI.callTestCase(findTestCase('OBSBA/Genericos/RegistrarObsba'), [('varCuil') : cuil, ('varPassword') : passDos, ('varPerfil') : 'Afiliado'
        , ('varUsuario') : usuario, ('varEmail') : emailMayuscula, ('varTelefono') : telefono, ('varDomicilio') : direccion
...
String logTexto= "***Log: Valida mensaje error: Registra un interno, luego lo intenta registrar como empleado y luego lo intenta registrar como afiliado con otro pass: "
