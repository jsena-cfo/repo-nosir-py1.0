...
String logTexto = ('***Log: Valida mensaje error: Registra al usuario interno ' + cuil.toString()) + ', luego lo intenta registrar como empleado y luego lo intenta registrar como afiliado con otro mail produciendo el error'
