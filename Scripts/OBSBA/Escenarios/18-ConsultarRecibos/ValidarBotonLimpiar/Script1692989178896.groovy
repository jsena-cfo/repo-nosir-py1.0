...
(mapBoolean['1']) = WebUI.verifyElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_ConsultarRecibos/button_Limpiar'), 
    0)

WebUI.callTestCase(findTestCase('OBSBA/Genericos/ClickLimpiar'), [:], FailureHandling.STOP_ON_FAILURE)

(mapBoolean['2']) = WebUI.verifyElementText(findTestObject('ObsbaPortal/Page_ObSBA_ConsultarRecibos/p_contadorPaginas'), 
    '0–0 of 0')
...
limpiado = !(mapBoolean.containsValue(false))
