...
/**Author: Jer**/
/**Se crea una carpeta con doc como interno**/
/**Se envia la carpeta**/
/**Se ingresa como un interno carga un doc no visible**/
/**Se ingresa como el afiliado y valida que no vea el doc y queda en estado privado**/
...
'Se crea una carpeta con doc como interno'
numeroCarpeta = WebUI.callTestCase(findTestCase('OBSBA/Genericos/CrearGenerarCarpetaDocParam'), [('varUsuario') : userInterno
...
WebUI.callTestCase(findTestCase('OBSBA/Genericos/ConsultarCarpetaAvanzado'), [('varAnio') : anio, ('varNumeroCarpeta') : numeroCarpeta
        , ('varFechaDesde') : fechaHoy, ('varFechaHasta') : fechaHoy, ('varCuil') : userInterno, ('varTipoCarpeta') : ''
...
'Se ingresa como otro interno carga un doc no visible'
WebUI.callTestCase(findTestCase('OBSBA/Genericos/Login'), [('Usuario') : userAdministrador, ('Contrasena') : pass], FailureHandling.STOP_ON_FAILURE)
...
'Se ingresa como el primer interno y valida que no vea el doc'
WebUI.callTestCase(findTestCase('OBSBA/Genericos/Login'), [('Usuario') : userInterno, ('Contrasena') : pass], FailureHandling.STOP_ON_FAILURE)
