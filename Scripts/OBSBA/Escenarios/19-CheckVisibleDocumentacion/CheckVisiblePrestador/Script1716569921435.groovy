...
/**Se ingresa como el prestador y valida que vea el doc y queda en estado público**/
...
'Se crea una carpeta con doc como prestador'
numeroCarpeta = WebUI.callTestCase(findTestCase('OBSBA/Genericos/CrearGenerarCarpetaDoc'), [('varUsuario') : userPrestador
