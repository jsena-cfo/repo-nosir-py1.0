...
/**Author: Jer**/
/**Valida que se visualiza el checkbox Visible 
 * en pantalla para un Interno**/
...
WebUI.scrollToElement(findTestObject('ObsbaPortal/Page_ObSBA_AdministrarCarpetaDocumento/chk_Visible_documento'), 1)

existeCheck = WebUI.verifyElementPresent(findTestObject('ObsbaPortal/Page_ObSBA_AdministrarCarpetaDocumento/chk_Visible_documento'), 
    1)
