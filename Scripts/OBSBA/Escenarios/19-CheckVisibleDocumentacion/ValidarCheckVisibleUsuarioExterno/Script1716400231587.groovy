...
/**Author: Jer**/
/**Valida que no se visualiza el checkbox Visible
 * en pantalla para un usuario Externo**/
boolean checkNoVisible = false

String numeroCarpeta

if (varReutilizacion) {
    numeroCarpeta = WebUI.callTestCase(findTestCase('OBSBA/Genericos/ObtenerNumeroCarpetaReutilizada'), [('varTipo') : 'prestadorCarDoc'
...
WebUI.scrollToElement(findTestObject('ObsbaPortal/Page_ObSBA_AdministrarCarpetaDocumento/button_SelectorTipoDocumento'), 
    1)

checkNoVisible = WebUI.verifyElementNotVisible(findTestObject('ObsbaPortal/Page_ObSBA_AdministrarCarpetaDocumento/chk_Visible_documento'))

WebUI.callTestCase(findTestCase('OBSBA/Genericos/Logout'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('OBSBA/Genericos/CerrarNavegador'), [:], FailureHandling.STOP_ON_FAILURE)

assert checkNoVisible
