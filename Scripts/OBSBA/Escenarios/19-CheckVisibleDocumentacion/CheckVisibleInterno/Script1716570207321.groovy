...
/**Se envia la carpeta**/
/**Se ingresa como otro interno carga un doc visible**/
/**Se ingresa como el primer interno y valida que vea el doc y queda en estado público**/
...
numeroCarpeta = WebUI.callTestCase(findTestCase('OBSBA/Genericos/CrearGenerarCarpetaDoc'), [('varUsuario') : userInterno
...
WebUI.callTestCase(findTestCase('OBSBA/Genericos/Login'), [('Usuario') : userInternoAdmin, ('Contrasena') : pass], FailureHandling.STOP_ON_FAILURE)
...
'Se ingresa como un prestador y valida que vea el doc'
WebUI.callTestCase(findTestCase('OBSBA/Genericos/Login'), [('Usuario') : userInterno, ('Contrasena') : pass], FailureHandling.STOP_ON_FAILURE)
