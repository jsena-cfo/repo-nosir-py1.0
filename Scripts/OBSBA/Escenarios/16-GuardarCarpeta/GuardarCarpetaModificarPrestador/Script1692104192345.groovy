...
/**Author: Jer**/
/**Script crea una carpeta con un usuario Prestador, modifica los campos**/
/**y valida que el campo haya sido modificado, crea una carpeta como Bien Salud y luego la
 * modifica a Fondo Compensador**/
...
not_run: String tituloGet2 = WebUI.getAttribute(findTestObject('ObsbaPortal/Page_ObSBA_AdministrarCarpeta/input_Titulo de carpeta'), 
    'value')
