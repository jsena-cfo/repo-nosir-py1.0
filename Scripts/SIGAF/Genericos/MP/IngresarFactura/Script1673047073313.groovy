...
for (row = 1; row <= cantRows; row++) {
    ...
    WebUI.callTestCase(findTestCase('SIGAF/Genericos/Obsba/CargarCabecera'), [('ejercicio') : ejercicio, ('nroCarpeta') : nroCarpeta, ('unidadEjecutora') : unidadEjecutora
            , ('ente') : ente, ('observaciones') : 'Test Automatizado'], FailureHandling.STOP_ON_FAILURE)

    WebUI.callTestCase(findTestCase('SIGAF/Genericos/Obsba/CargarDetallePresupuestario'), [('objetoGasto') : '6952', ('acta') : '035'
            , ('ff') : '31', ('tm') : '1', ('ug') : '1'], FailureHandling.STOP_ON_FAILURE)
