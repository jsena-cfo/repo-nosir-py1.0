...
WebUI.callTestCase(findTestCase('SIGAF/Genericos/MP/TransicionarPendiente'), [:], FailureHandling.STOP_ON_FAILURE)
...
if (estadoActualizadoAux == "PENDIENTE") {
	System.out.println('El estado cambio a PENDIENTE')
	assert true
} else {
	System.out.println('El estado no cambio a PENDIENTE')
	assert false
}
