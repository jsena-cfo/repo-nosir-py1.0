...
not_run: for (int index : (1..cantidadFilasXls)) {
    not_run: String numeroInterno

    not_run: numeroInterno = WebUI.callTestCase(findTestCase('SIGAF/Genericos/Varios/ObtenerTextoRegionOCR'), [('varX') : '103'
