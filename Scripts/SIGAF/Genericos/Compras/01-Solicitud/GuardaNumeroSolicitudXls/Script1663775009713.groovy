...
String excelFilePath = 'Xls/numeroSolicitudGastoXls.xlsx'
String sheetName = 'Hoja1'
String numeroVar = this.getBinding().getAt('varNumero').toString()
...
ExcelKeywords.setValueToCellByIndex(sheet01, filaSiguiente, 0, numeroVar)
ExcelKeywords.setValueToCellByIndex(sheet01, filaSiguiente, 1, diaHoy)
