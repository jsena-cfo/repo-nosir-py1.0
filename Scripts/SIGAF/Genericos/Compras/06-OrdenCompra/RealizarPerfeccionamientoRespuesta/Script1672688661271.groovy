...
WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/06-OrdenCompra/DesplazarseMenu'), [('varOpcion') : 'perfeccionamientoRespuesta'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/06-OrdenCompra/RecepcionOrdenCompra'), [:], FailureHandling.STOP_ON_FAILURE)
