...
WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/06-OrdenCompra/DesplazarseMenu'), [('varOpcion') : 'perfeccionamientoEnvio'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/06-OrdenCompra/EnviarOrdenCompra'), [:], FailureHandling.STOP_ON_FAILURE)
