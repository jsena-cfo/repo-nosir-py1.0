...
WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/06-OrdenCompra/DesplazarseMenu'), [('varOpcion') : 'partePercepcionDefinitiva'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/06-OrdenCompra/IrAIngreso'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/06-OrdenCompra/ParteRecepcionDefinitiva'), [:], FailureHandling.STOP_ON_FAILURE)
