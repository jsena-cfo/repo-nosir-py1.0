...
WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/05-Adjudicacion/DesplazarseMenu'), [('varOpcion') : 'protocolizacion'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/05-Adjudicacion/SeleccionarProcedimiento'), [('varNumeroContratacion') : numeroContratacion], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/05-Adjudicacion/IngresarDatos'), [('varNumeroContratacion') : numeroContratacion], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('SIGAF/Genericos/Compras/05-Adjudicacion/AutorizarActoAdjudicacion'), [:], FailureHandling.STOP_ON_FAILURE)
