...
WebUI.callTestCase(findTestCase('BAO/Genericos/Proveedor/Ofertar'), [('proveedor') : GlobalVariable.userProveedor, ('pass') : GlobalVariable.pass
        , ('cantidad') : '6', ('precio') : '10', ('pliego') : GlobalVariable.nroPC], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAO/Genericos/Proveedor/Ofertar'), [('proveedor') : GlobalVariable.userProveedor2, ('pass') : GlobalVariable.pass
        , ('cantidad') : '4', ('precio') : '10', ('pliego') : GlobalVariable.nroPC], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAO/Genericos/Pre Adjudicacion/EvaluarOfertas'), [('cantPrimerOferta') : '6', ('cantSegundaOferta') : '4'], 
    FailureHandling.STOP_ON_FAILURE)
