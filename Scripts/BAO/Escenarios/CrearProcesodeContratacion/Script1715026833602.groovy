...
WebUI.callTestCase(findTestCase('BAO/Genericos/Proceso de Contratacion/CompletarInfoBasicaPC'), [('cantDias') : '20', ('tipoDeDias') : 'Días corridos'
        ...
        , ('cotizCantidad') : 'Parcial', ('cotizRenglones') : 'Parcial', ('tipoEnvio') : 'General', ('tipoRedet') : 'Acepta redeterminación total'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAO/Genericos/Proceso de Contratacion/CompletarSupervisor'), [('supervisor') : 'JULIETA LANDIN'], 
    FailureHandling.STOP_ON_FAILURE)
