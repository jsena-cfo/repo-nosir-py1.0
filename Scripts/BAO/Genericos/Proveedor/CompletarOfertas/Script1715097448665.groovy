...
/*
try {
    WebUI.setText(findTestObject('Object Repository/BAC/Page_BAC - Vista Proveedor/inpCantidadItems'), cantidad, FailureHandling.CONTINUE_ON_FAILURE)
}
catch (Exception ex) {
    println(ex)
} 
*/
WebUI.setText(findTestObject('BAO/Proveedor/inpPrecioTotal'), precio)
