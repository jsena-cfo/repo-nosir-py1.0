...
//WebUI.waitForElementClickable(findTestObject('BAO/Proceso de Contratacion/Busqueda Proceso/btnEditar', [('accion') : accion]), 4)
WebUI.click(findTestObject('BAO/Proceso de Contratacion/Busqueda Proceso/btnEditar', [('accion') : accion]))
