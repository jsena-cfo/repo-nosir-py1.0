...
def proveedores = ['SociedadAnonima', 'SociedadHecho', 'Cooperativas', 'UnionTransitoria', 'TalleresProtegidos', 'SociedadResponsabilidad'
    , 'OtrasFormasSocietarias']

for (def tipoProveedor : proveedores) {
    ...
    if (tipoProveedor != 'UnionTransitoria') {
    ...
    } else if (tipoProveedor == 'TalleresProtegidos') {
        WebUI.setText(findTestObject('RIUPP/Page_BAC - Indice 2/inputREGICE'), 'test')
    }
    
	WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.PreInscripcion/Indice2-InfoBasica/CompletarDomicilioLegal'), [('provincia') : 'Buenos Aires'
		, ('partido') : 'ADOLFO ALSINA', ('localidad') : 'LA PALA'], FailureHandling.STOP_ON_FAILURE)

    WebUI.verifyElementNotClickable(findTestObject('Object Repository/RIUPP/Page_BAC - Indice 2/chkUsarMismoDomicilio'))
