...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/DesactualizarPorOficioProveedor'), [('razonSocial') : GlobalVariable.razonSocial], 
...
EstadoRegistralProveedor('Desactualizado por Oficio')
...
try {
    WebUI.check(findTestObject('RIUPP/Page_BAC - Indice 5/chkDecJuradaIIBB'))
}
catch (Exception ex) {
} 
