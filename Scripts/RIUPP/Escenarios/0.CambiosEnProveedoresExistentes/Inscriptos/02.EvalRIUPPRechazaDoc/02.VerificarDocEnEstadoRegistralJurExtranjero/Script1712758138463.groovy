...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.EvaluacionRIUPP/RechazarIBB'), [('tipoProveedor') : tipoProveedor], FailureHandling.STOP_ON_FAILURE)
...
assert estadoRegistral == 'Registrado' : 'Estado registral erroneo'
