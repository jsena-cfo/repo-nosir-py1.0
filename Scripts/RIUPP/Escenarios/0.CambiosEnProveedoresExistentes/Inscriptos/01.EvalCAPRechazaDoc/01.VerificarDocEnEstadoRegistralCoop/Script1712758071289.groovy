...
'Indice 1'
not_run: WebUI.check(findTestObject('RIUPP/Evaluacion CAP/Indice1/rbDatosBasicosAprobado'))
...
not_run: WebUI.click(findTestObject('RIUPP/Evaluacion CAP/Indice1/btnSiguiente'))
