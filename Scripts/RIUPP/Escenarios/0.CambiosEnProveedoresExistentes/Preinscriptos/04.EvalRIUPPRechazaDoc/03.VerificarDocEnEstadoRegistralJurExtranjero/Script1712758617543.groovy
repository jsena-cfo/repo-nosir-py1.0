...
WebUI.callTestCase(findTestCase('RIUPP/Escenarios/0.PreInscripcionProveedores/PreInscripcionJuridicoExtranjero'), [('tipoProveedor') : 'JuridicoExtranjero'], 
...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.EvaluacionRIUPP/RechazarCertificadoSalud'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('RIUPP/Menu Consultar Estado Registral/spanSinDocsParametrizado', [('doc') : 'Certificado por el Organismo de Sanidad Nacional']), 
    5)
