...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.PreInscripcion/Indice1-Preinscripcion/CompletarDatosProvNacional'), [('tipoProveedor') : 'UnionTransitoria'], 
...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.PreInscripcion/Indice4-SubirDocumentacion/ValidarArchivoGenerico'), [('nombreDoc') : 'Contrato constitutivo de la UTE'
...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.PreInscripcion/Indice4-SubirDocumentacion/ValidarArchivoGenerico'), [('nombreDoc') : 'Instrumento donde conste la designación de representante/s legal/es'
        , ('fileMax') : 15], FailureHandling.STOP_ON_FAILURE) 	
