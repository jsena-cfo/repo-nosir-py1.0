...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.PreInscripcion/Indice1-Preinscripcion/CompletarDatosProvNacional'), [('tipoProveedor') : 'TalleresProtegidos'], 
...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.PreInscripcion/Indice4-SubirDocumentacion/ValidarArchivoGenerico'), [('nombreDoc') : 'Constancia de inscripción en el Registro de Instituciones de Capacitación y Empleo'
	, ('fileMax') : 15], FailureHandling.STOP_ON_FAILURE)
