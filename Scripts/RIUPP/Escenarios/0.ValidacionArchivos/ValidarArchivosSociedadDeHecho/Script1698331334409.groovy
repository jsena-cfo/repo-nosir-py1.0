...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.PreInscripcion/Indice1-Preinscripcion/CompletarDatosProvNacional'), [('tipoProveedor') : 'SociedadHecho'],
...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.PreInscripcion/Indice4-SubirDocumentacion/ValidarArchivoGenerico'), [('nombreDoc') : 'Documento de Identidad de los integrantes de la Sociedad de Hecho'
