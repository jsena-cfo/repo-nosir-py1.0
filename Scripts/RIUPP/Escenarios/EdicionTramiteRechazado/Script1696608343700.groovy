...
WebUI.callTestCase(findTestCase('RIUPP/Escenarios/RechazarConEvaluadorRIUPP'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('RIUPP/Escenarios/0.Panel Mis Tramites/BuscarTramiteRechazado'), [:], FailureHandling.STOP_ON_FAILURE)
