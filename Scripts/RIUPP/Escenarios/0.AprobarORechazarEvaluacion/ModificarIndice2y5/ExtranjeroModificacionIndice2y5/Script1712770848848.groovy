...
WebUI.callTestCase(findTestCase('RIUPP/Escenarios/0.CreacionProveedores/CrearProveedorJuridicoExtranjero'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('RIUPP/Page_BAC - Indice 2/input_Calle'), 'Test Modificacion')
...
WebUI.check(findTestObject('RIUPP/Page_BAC - Indice 5/chkItemParametrizado', [('clase') : '19.01.001']))
...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.EvaluacionCAP/ReEvaluacionCAPVerificaFechas'), [:], FailureHandling.STOP_ON_FAILURE)
