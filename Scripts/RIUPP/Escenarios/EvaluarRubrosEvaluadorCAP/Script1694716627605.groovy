...
not_run: WebUI.callTestCase(findTestCase('RIUPP/Escenarios/0.PreInscripcionProveedores/PreInscripcionCooperativa'), [('tipoProveedor') : 'Cooperativas'], 
...
WebUI.callTestCase(findTestCase('RIUPP/Genericos/0.EvaluacionCAP/EvaluarIndice3'), [('tipoProveedor') : tipoProveedor], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('RIUPP/Evaluacion CAP/Indice3/btnSiguiente'))

WebUI.verifyElementHasAttribute(findTestObject('RIUPP/Evaluacion RIUPP/rbAprobadoPrimerClase'), 'disabled', 5)

WebUI.verifyElementHasAttribute(findTestObject('RIUPP/Evaluacion RIUPP/rbAprobadoSegundaClase'), 'disabled', 5)

WebUI.verifyElementNotPresent(findTestObject('RIUPP/Evaluacion RIUPP/btnFinalizarEvaluacion'), 3)
