...
if ((tipoProveedor != 'Persona jurídica extranjera sin sucursal') && (tipoProveedor != 'Persona humana')) {
    WebUI.check(findTestObject('RIUPP/Evaluacion CAP/Indice3/rbTamanoEmpresaRechazado'))

    WebUI.setText(findTestObject('RIUPP/Evaluacion CAP/Indice3/textareaTamanoEmpresaObservaciones'), 'test qa automation test')

    WebUI.check(findTestObject('RIUPP/Evaluacion CAP/Indice3/rbOtraInformacionAprobado'))

    WebUI.setText(findTestObject('RIUPP/Evaluacion CAP/Indice3/inputOtraInformacionFecha'), 'test automation qa test')
}
...
switch (tipoProveedor) {
    case 'Persona humana':
        ...
        WebUI.check(findTestObject('RIUPP/Evaluacion CAP/Indice3/rbRechazadoParametrizado', [('doc') : 'Documento de identidad del Titular']))

        WebUI.setText(findTestObject('RIUPP/Evaluacion CAP/Indice3/txtAreaObservacionesParametrizado', [('doc') : 'Documento de identidad del Titular']), 
            'test automation qa test')
    ...
    case 'Persona jurídica extranjera sin sucursal':
        ...
        if (esSimplificado == 'NO') {
            WebUI.check(findTestObject('RIUPP/Evaluacion CAP/Indice3/rbRechazadoParametrizado', [('doc') : 'Certificado de firmas']))

            WebUI.setText(findTestObject('RIUPP/Evaluacion CAP/Indice3/txtAreaObservacionesParametrizado', [('doc') : 'Certificado de firmas']), 
                'test automation qa test')
