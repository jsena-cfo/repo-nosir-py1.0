...
WebUI.setText(findTestObject('RIUPP/Page_BAC - Sistema de compras pblicas/inputCUIT'), GlobalVariable.cuitProveedor)

WebUI.setText(findTestObject('RIUPP/Page_BAC - Sistema de compras pblicas/inputCorreo'), GlobalVariable.cuitProveedor + 
    '@test.com')
