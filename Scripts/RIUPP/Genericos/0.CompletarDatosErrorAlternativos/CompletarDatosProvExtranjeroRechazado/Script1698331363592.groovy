...
WebUI.selectOptionByLabel(findTestObject('RIUPP/Page_BAC - Sistema de compras pblicas/selectPais'), 'Mexico', false)

WebUI.selectOptionByLabel(findTestObject('RIUPP/Page_BAC - Sistema de compras pblicas/select_TipoIDTributario'), 'RFC', 
    false)

WebUI.setText(findTestObject('RIUPP/Page_BAC - Sistema de compras pblicas/inputIDTributario'), 'IME090528513')
