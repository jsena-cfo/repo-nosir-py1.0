...
WebUI.setText(findTestObject('RIUPP/Page_BAC - Sistema de compras pblicas/inputRazonSocial'), 'scallyroy')

WebUI.setText(findTestObject('RIUPP/Page_BAC - Sistema de compras pblicas/inputCUIT'), '30711354081')

WebUI.setText(findTestObject('RIUPP/Page_BAC - Sistema de compras pblicas/inputCorreo'), 'scallyroyQA@test.com')
