...
WebUI.selectOptionByLabel(findTestObject('RIUPP/Page_BAC - Indice 2/selectPais'), 'Paraguay', false)
...
WebUI.click(findTestObject('RIUPP/Page_BAC - Indice 2/btnSiguiente'))
