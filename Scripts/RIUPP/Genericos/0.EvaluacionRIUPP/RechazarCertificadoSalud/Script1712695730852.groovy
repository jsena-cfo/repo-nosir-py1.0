...
WebUI.check(findTestObject('RIUPP/Evaluacion RIUPP/rbCertificado_SaludRechazado'))
...
WebUI.setText(findTestObject('RIUPP/Evaluacion RIUPP/textareaObservacionesCertificadoSalud'), 'test qa automation test')
