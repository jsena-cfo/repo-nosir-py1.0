...
WebUI.callTestCase(findTestCase('BAC/Genericos/Varios/CambiarUnidadEjecutora'), [('nombreUE') : GlobalVariable.unidadEjecutora], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/Solicitud de Gasto/CompletarInfoBasica'), [('unidadSolicitante') : 'QA'
		, ('urgencia') : 'UrgenciaNormal'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/Solicitud de Gasto/CompletarItems'), [('codigoItem') : item1
		, ('acondicionamiento') : 'test', ('cantidad') : '10', ('empaquetamiento') : 'Caja x 12 U', ('cantEmpaquetamiento') : '1'
		, ('precioUnitario') : '1'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/Solicitud de Gasto/CompletarItems'), [('codigoItem') : item2
		, ('acondicionamiento') : 'test', ('cantidad') : '10', ('empaquetamiento') : 'Caja x 12 U', ('cantEmpaquetamiento') : '1'
		, ('precioUnitario') : '1'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/Solicitud de Gasto/CompletarDetallesEntrega'), [('codigoItem') : item1
		, ('plazoEntrega') : '15'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/Solicitud de Gasto/CompletarDetallesEntrega'), [('codigoItem') : item2
		, ('plazoEntrega') : '15'], FailureHandling.STOP_ON_FAILURE)
