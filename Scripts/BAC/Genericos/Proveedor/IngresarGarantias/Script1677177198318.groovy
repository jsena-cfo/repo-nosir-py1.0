...
WebUI.setText(findTestObject('BAC/Page_BAC - Vista Proveedor/inpMonto'), '30')
...
WebUI.verifyElementClickable(findTestObject('Object Repository/BAC/Page_BAC - Vista Proveedor/td_Ingresada'))
