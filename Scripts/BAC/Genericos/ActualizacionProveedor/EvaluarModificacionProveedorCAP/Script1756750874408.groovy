...
WebUI.callTestCase(findTestCase('BAC/Genericos/ActualizacionProveedor/ClickAsignar'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/ActualizacionProveedor/ClickAccionAprobar'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/ActualizacionProveedor/ClickSiguientePaso1'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/ActualizacionProveedor/ClickSiguientePaso2'), [:], FailureHandling.STOP_ON_FAILURE)
...
capEvaluado= WebUI.verifyElementPresent(findTestObject('BAC/ActualizacionProveedor/span_msjEvaluacinCAP'), 2)
