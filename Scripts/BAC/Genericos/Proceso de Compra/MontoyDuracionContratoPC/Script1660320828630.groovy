...
WebUI.selectOptionByLabel(findTestObject('BAC/Page_BAC - Proceso de Compra/Page BAC - MontoYDuracion/select_DiarioSemanalQuincenalMensual'), semanal, 
    false)
...
WebUI.selectOptionByLabel(findTestObject('BAC/Page_BAC - Proceso de Compra/Page BAC - MontoYDuracion/select_SeleccionarDiasSemanas'), tiempo, false)
