...
def fechaPublicacion = CustomKeywords.'tool.DateGenerator.getNextValidWorkingDay'(1)

def fechaInicio = CustomKeywords.'tool.DateGenerator.getNextValidWorkingDay'(2)

def fechaFin = CustomKeywords.'tool.DateGenerator.getNextValidWorkingDay'(5)
...
WebUI.sendKeys(findTestObject('BAC/Page_BAC - Proceso de Compra/Page_BAC - Cronograma/inpHoraEstimadaPublicacion'), hora)
...
WebUI.waitForElementPresent(findTestObject('BAC/Page_BAC - Proceso de Compra/Page_BAC - Cronograma/inpHoraActoApertura'), 5)

WebUI.sendKeys(findTestObject('BAC/Page_BAC - Proceso de Compra/Page_BAC - Cronograma/inpHoraActoApertura'), hora)
