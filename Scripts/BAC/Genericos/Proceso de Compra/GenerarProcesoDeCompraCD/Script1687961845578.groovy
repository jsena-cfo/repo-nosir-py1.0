...
WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/CompletarSG-PC'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/SeleccionDeProveedoresCD'), [('razonsocial') : 'CIENTIFICA PARQUE CENTENARIO S.R.L.'
        , ('justificacion') : 'Test QA'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/SeleccionDeProveedoresCD'), [('razonsocial') : 'MEDI SISTEM S.R.L.'
        , ('justificacion') : 'Test QA'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/BuscarPC'), [('nroPC') : nroCompra, ('user') : GlobalVariable.userAutorizador
        , ('pass') : GlobalVariable.passAutorizador, ('accionPC') : 'Editar Proceso'], FailureHandling.STOP_ON_FAILURE)
...
if (WebUI.verifyTextPresent('El cronograma fue ingresado con éxito. Se autorizó el llamado.', false)) {
