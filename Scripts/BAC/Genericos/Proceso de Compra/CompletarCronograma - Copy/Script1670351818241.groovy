...
def fechaPublicacion = CustomKeywords.'tool.DateGenerator.getNextValidWorkingDay'(3)

def fechaInicio = CustomKeywords.'tool.DateGenerator.getNextValidWorkingDay'(4)
