...
WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/BuscarAfectacionPC'), [('user') : GlobalVariable.userAnalista
        , ('pass') : GlobalVariable.passAnalista, ('nroPC') : nroAmpliacion], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyTextPresent('El Compromiso Definitivo fue afectado Satisfactoriamente. Se ha notificado al Analista OGEPU para su análisis.', 
    false)
