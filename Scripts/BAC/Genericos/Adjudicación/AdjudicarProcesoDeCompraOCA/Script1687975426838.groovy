...
WebUI.selectOptionByLabel(findTestObject('BAC/Page_BAC - Adjudicación/selectAnalistaOGEPU OCA'), 'Sandra Mazza', true)
...
not_run: WebUI.click(findTestObject('Object Repository/BAC/Page_BAC - Adjudicación/btn_AgregarSupervisor'))

WebUI.click(findTestObject('BAC/Page_BAC - Adjudicación/btnEnviarAnalistaOGEPU'))
