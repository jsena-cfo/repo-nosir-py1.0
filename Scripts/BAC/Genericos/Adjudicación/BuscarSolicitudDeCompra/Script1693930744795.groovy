...
WebUI.click(findTestObject('BAC/Home/li_BuscarSC'))

WebUI.setText(findTestObject('BAC/Adjudicacion/Solicitud de Compra/inpNroSolicitud'), GlobalVariable.nroSC)

WebUI.click(findTestObject('BAC/Adjudicacion/Solicitud de Compra/btnLupaBuscarSC'))
