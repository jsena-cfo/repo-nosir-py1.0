...
WebUI.callTestCase(findTestCase('BAC/Genericos/Adjudicación/IngresarCompromisoDefinitivoCU'), [('pass') : GlobalVariable.passAutorizador
        , ('monto') : '10'], FailureHandling.STOP_ON_FAILURE)

WebUI.selectOptionByLabel(findTestObject('BAC/Page_BAC - Adjudicación/selectAnalistaOGEPU'), 'Sandra Mazza', true)
