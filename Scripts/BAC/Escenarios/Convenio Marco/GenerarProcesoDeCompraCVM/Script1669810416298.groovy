...
def nroCompra = WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/CompletarDatosBasicosPC'), [('nombrePC') : 'QA Test '
        , ('procedimiento') : modalidad, ('modalidad') : modalidad], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/DetalleDeProductosOServicios'), [('codigoDeItem') : '33.01.002.0155.1'
        , ('embalaje') : '15', ('cantidad') : '10'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/DetalleDeProductosOServicios'), [('codigoDeItem') : '33.02.002.0025.10'
        , ('embalaje') : '15', ('cantidad') : '10'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/CompletarGarantias'), [('porcGarantiaImpugnacion') : '1'
        ...
        , ('procedimiento') : procedimiento], FailureHandling.STOP_ON_FAILURE)
