...
WebUI.callTestCase(findTestCase('BAC/Genericos/Pre Adjudicacion/Circular'), [('textoDescripcion') : 'test qa', ('textoAclaratoria') : '123456test'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.delay(60)
*/
not_run: WebUI.callTestCase(findTestCase('BAC/Genericos/Pre Adjudicacion/BuscarGarantias'), [:], FailureHandling.STOP_ON_FAILURE)
