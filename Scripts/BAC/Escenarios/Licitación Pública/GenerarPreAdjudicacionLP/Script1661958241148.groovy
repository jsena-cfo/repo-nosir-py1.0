...
WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/BuscarPCDesdeHomePage'), [('nroPC') : GlobalVariable.nroPC
        , ('user') : GlobalVariable.userEvaluador2, ('pass') : GlobalVariable.passEvaluador], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/Pre Adjudicacion/RealizarEvaluaciones'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/Pre Adjudicacion/EvaluarOfertas (DEPRECADO)'), [:], FailureHandling.STOP_ON_FAILURE)
