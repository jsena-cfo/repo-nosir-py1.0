...
/**Author: Jer**/
/**Script valida que los precios de la solicitud de actualizacion se hayan modificado con el paso previo**/
...
WebUI.waitForElementPresent(findTestObject('BAC/ActualizacionPrecios/Page_BAC - ConsultaSolicitudesActualizacion/a_linkOca'), 
    2)

WebUI.click(findTestObject('BAC/ActualizacionPrecios/Page_BAC - ConsultaSolicitudesActualizacion/a_linkOca'))

flujoValidado = WebUI.callTestCase(findTestCase('BAC/Genericos/ActualizacionPrecios/ValidarActualizacionPreciosModificado'), 
    [('varValor') : 'modificada', ('varNumeroOca') : numeroOCA, ('varMonto1') : precioDecrementoVar, ('varMonto2') : precioIncrementoVar
        , ('varMoneda') : monedaVar], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/ActualizacionPrecios/Logout'), [:], FailureHandling.STOP_ON_FAILURE)

assert flujoValidado
