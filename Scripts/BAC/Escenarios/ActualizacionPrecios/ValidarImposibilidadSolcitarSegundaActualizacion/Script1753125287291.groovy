...
/**Author: Jer**/
/**Validar que no se encuentra el boton para realizar la segunda solicitud de actualizacion, 
 * luego de hacer la primera el mismo dia**/

boolean botonSolicitarActualizacionPresente = false
...
botonSolicitarActualizacionPresente = WebUI.verifyElementNotPresent(findTestObject('BAC/ActualizacionPrecios/Page_BAC - SolicitudActualizacionPrecios/input_SolicitarActualizacionDePrecios'), 
    2)

WebUI.callTestCase(findTestCase('BAC/Genericos/ActualizacionPrecios/Logout'), [:], FailureHandling.STOP_ON_FAILURE)

assert botonSolicitarActualizacionPresente
