...
WebUI.callTestCase(findTestCase('BAC/Escenarios/Proveedor/OfertarParcialParcial'), [('proveedor') : GlobalVariable.userProveedor2
        , ('pass') : '12345678', ('cantidad') : '4', ('precio') : '1', ('pliego') : GlobalVariable.nroPC], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/Pre Adjudicacion/RecomendarOfertaParcialParcial'), [('nroPC') : GlobalVariable.nroPC], 
    FailureHandling.STOP_ON_FAILURE)
