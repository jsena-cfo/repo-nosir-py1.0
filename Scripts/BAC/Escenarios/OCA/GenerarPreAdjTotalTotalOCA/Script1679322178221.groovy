...
WebUI.callTestCase(findTestCase('BAC/Escenarios/Proveedor/OfertarTotalTotal'), [('precio') : '2', ('proveedor') : GlobalVariable.userProveedor
        , ('pass') : '12345678', ('pliego') : GlobalVariable.nroPC], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Escenarios/Proveedor/OfertarTotalTotal'), [('precio') : '1', ('proveedor') : GlobalVariable.userProveedor2
        , ('pass') : '12345678', ('pliego') : GlobalVariable.nroPC], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/Pre Adjudicacion/EvaluarOfertasTotalTotal'), [('cantPrimerOferta') : '6', ('cantSegundaOferta') : '4'], 
    FailureHandling.STOP_ON_FAILURE)
