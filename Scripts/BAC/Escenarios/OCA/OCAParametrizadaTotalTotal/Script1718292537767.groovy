...
for (int i = 1; i < rowCount; i++) {
    ...
    String nroCompra = WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/CompletarDatosBasicosPC-OCA'), [('nombrePC') : 'QA Test'], 
        FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.callTestCase(findTestCase('BAC/Genericos/Proceso de Compra/CompletarInfoBasicaPC'), [('cantDias') : '20', ('tipoDeDias') : 'Días corridos'
            ...
            , ('cotizCantidad') : 'Total', ('cotizRenglones') : 'Total', ('redeterminable') : esRedeterminable], FailureHandling.STOP_ON_FAILURE)
