...
WebUI.callTestCase(findTestCase('BAC/Genericos/Ampliacion/CompletarIndice1Justificacion'), [('accion') : 'Ingresar Solicitud de Prórroga'], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/Prorroga/Indice3PlazoYDuracion'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('BAC/Genericos/Prorroga/CompletarIndice6ProyectoDeActoAdmin'), [('nroAmpliacion') : nroAmpliacion], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('BAC/Genericos/Prorroga/RecepcionarConProveedor'), [('user') : 'dettano', ('pass') : '12345678'
        , ('nroDocContractual') : ''], FailureHandling.STOP_ON_FAILURE)
